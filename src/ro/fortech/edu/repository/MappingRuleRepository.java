...
public class MappingRuleRepository {
    ...
    public List<EvaluationRule> findAllMappingRules() {
        ...
        criteria.select(evaluationRule).where(cb.equal(isMappingRule, 1));      
        return em.createQuery(criteria).getResultList();
    }
    
    
	public EvaluationRule findMappingById(long id) {
